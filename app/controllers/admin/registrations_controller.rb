class Admins::RegistrationsController < Devise::RegistrationsController
  ...
  def update
    ...
    #     redirect_to backoffice_home_index_path, notice: "Usuário atualizado com sucesso."
    #   else
    #     redirect_to edit_admin_registration_path, notice: resource.errors.full_messages.to_sentence
    #   end
    # else
    #   redirect_to backoffice_home_index_path, notice: "Usuário atualizado com sucesso."
    # end
  ...
  def set_avatar_deleted
    if avatar_isempty
      @admin.avatar.attach(io: File.open(Rails.root + 'app/assets/images/emptyuser.png'), filename: 'emptyuser.png')
    end
  end
